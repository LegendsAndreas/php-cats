...
<div class="cats-add">
    ...
    <div class="cats-add__level-1">
        ...
        echo $this->Form->control('function_name', [
            ...
            'required' => true,
            'templates' => [
                'inputContainer' => '<div class="cats-add__level-2">{{content}}</div>',
            ],
        ]);
        ...
        echo $this->Form->control('Image', [
            ...
            'class' => 'js-add-image',
            'templates' => [
                'inputContainer' => '<div class="cats-add__level-2 cats-add__image-input">{{content}}</div>',
            ],
        ]);
        echo $this->Form->control('base64_image', ['type' => 'hidden', 'id' => 'base64_image']);
        ?>

        <div class="cats-add__level-2">
